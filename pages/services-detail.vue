                ...
                <div class="container">
                    <div class="relative items-center py-14 lg:flex lg:py-[100px]">
                        <div class="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-3/5">
                            ...
                            <NuxtLink to="/about-us" class="btn mt-2 capitalize text-white">Book a free consultation</NuxtLink>
                        </div>
                        <div
            ...
            <div class="container">
                ...
                <div class="grid gap-[30px] sm:grid-cols-2">
                    <div
                        ...
                        data-aos-duration="1000"
                    >
                        <NuxtLink to="/portfolio-detail" class="absolute top-0 z-[1] h-full w-full ltr:left-0 rtl:right-0"></NuxtLink>
