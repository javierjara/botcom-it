        ...
        <div class="relative overflow-hidden bg-black pt-[106px]">
            ...
            <div class="container">
                <div class="relative pb-14 pt-10 md:pt-16 xl:pb-52">
                    ...
                    <div
                        class="bottom-0 z-[1] mx-auto mt-10 h-[93%] ltr:-right-56 rtl:-left-56 rtl:rotate-y-180 sm:w-1/2 xl:absolute xl:mx-0 xl:mt-0 xl:w-auto"
                    >
            ...
            <div class="container">
                <div class="grid gap-y-10 gap-x-4 uppercase italic sm:grid-cols-2 lg:grid-cols-4">
                    <div class="space-y-5 text-center">
                        <count-up class="text-5xl font-black text-white" :startVal="0" :end-val="10" :duration="10"></count-up>
                        <p class="text-lg font-semibold">Years of Expertise</p>
                    </div>
                    <div class="space-y-5 text-center">
                        <count-up class="text-5xl font-black text-white" :startVal="0" :end-val="15" :duration="10"></count-up>
                        <p class="text-lg font-semibold">Professional Coaches</p>
                    </div>
                    <div class="space-y-5 text-center">
                        <count-up class="text-5xl font-black text-white" :startVal="0" :end-val="20" :duration="10"></count-up>
                        <p class="text-lg font-semibold">Different Classes</p>
                    </div>
                    <div class="space-y-5 text-center">
                        <count-up class="text-5xl font-black text-white" :startVal="0" :end-val="535" :duration="10"></count-up>
                ...
                <div class="mt-8 grid gap-y-10 gap-x-7 italic sm:grid-cols-2 md:mt-12 lg:grid-cols-3">
                    <div class="group" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="pt-5 font-extrabold">
                            ...
                            <a
                                href="javascript:"
                                class="my-3 block text-[22px] leading-9 text-black transition line-clamp-2 hover:text-secondary dark:text-white"
