                ...
                <div class="container">
                    <div class="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                            <h6>Career</h6>
                            <h4 class="!text-white">Join our team at <span class="text-primary">Plurk</span></h4>
                        </div>
                        <div class="relative mt-6 md:mt-0" :data-aos="store.direction === 'rtl' ? 'fade-right' : 'fade-left'" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <path
                                    ...
                                    fill="#47BDFF"
                                />
                                <path d="M120.356 110.007L137.716 108.635L138.948 124.315L132.424 132.015L121.588 125.827L120.356 110.007Z" fill="#47BDFF" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M44.6736 102.672L55.2015 152.596" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M164.874 163.628L151.183 98.668" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M172.909 43.3105L143.344 62.0454" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M104.452 167.882L82.556 158" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M123.688 79.8242L128.588 83.6322" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M33.5015 196.386L38.6254 195.238" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M47.6979 193.166L52.8219 192.018" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M40.9778 184.543L42.1538 189.667" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M44.1979 198.738L45.3459 203.862" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M34.7896 188.91L39.2415 191.71" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M47.11 196.693L51.534 199.493" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M48.4536 185.83L45.6536 190.282" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M40.67 198.121L37.87 202.573" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                ...
                <div class="grid items-center gap-8 md:grid-cols-3 lg:grid-cols-2 xl:items-start">
                    <div class="order-2 md:order-1 md:col-span-2 lg:col-auto">
                        ...
                        <div class="text-center font-semibold ltr:md:text-left rtl:md:text-right">
                            <p class="pb-5">Find out everything you need to know and more about how we create our business process models.</p>
                            <p>
                            ...
                            <NuxtLink :to="{ name: 'career', hash: '#open-position' }" class="btn mt-10 capitalize text-white">Open Positions</NuxtLink>
                        </div>
                    </div>
                    <img
                ...
                <div class="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">Health Insurance</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">Employee Allowance</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">Perks & Bonuses</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">4 weeks PTO</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">Flexible Work Environment</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">Healthy Snacks</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="projects grid gap-[30px] md:grid-cols-2">
                    <div class="project" :class="activeTab === 'all' || activeTab === 'design' ? 'block' : 'hidden'">
                        ...
                        >
                            <h6 class="mb-5 text-base font-black uppercase text-secondary dark:group-hover:text-black">Design</h6>
                            <h4 class="mb-10 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Lead Mobile UI/UX Designer</h4>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="font-bold text-black dark:text-white sm:text-lg">
                                        San Francisco, CA - <span class="text-primary">Full Time</span>
                                    </div>
                                </div>
                                <a
                                    href="javascript:"
                    ...
                    <div class="project" :class="activeTab === 'all' || activeTab === 'website' ? 'block' : 'hidden'">
                        <div
                            class="group rounded-[32px] border-2 border-white bg-white px-4 py-6 transition hover:border-secondary hover:bg-secondary/10 dark:border-gray-dark dark:bg-gray-dark dark:hover:border-secondary dark:hover:bg-secondary sm:p-[30px]"
                        >
                            <h6 class="mb-5 text-base font-black uppercase text-secondary dark:group-hover:text-black">Website development</h6>
                            <h4 class="mb-10 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Sr. Systems Engineer - Java</h4>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div>
                                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="font-bold text-black dark:text-white sm:text-lg">Memphis, TN - <span class="text-primary">Remote</span></div>
                                </div>
                                <a
                                    href="javascript:"
                                    class="flex h-[45px] w-[45px] items-center justify-center rounded-full bg-[#F3F4F6] text-black transition hover:bg-secondary hover:text-white rtl:rotate-180 dark:bg-black dark:text-white"
                    ...
                    <div class="project" :class="activeTab === 'all' || activeTab === 'app' ? 'block' : 'hidden'">
                        <div
                            class="group rounded-[32px] border-2 border-white bg-white px-4 py-6 transition hover:border-secondary hover:bg-secondary/10 dark:border-gray-dark dark:bg-gray-dark dark:hover:border-secondary dark:hover:bg-secondary sm:p-[30px]"
                        >
                            <h6 class="mb-5 text-base font-black uppercase text-secondary dark:group-hover:text-black">application development</h6>
                            <h4 class="mb-10 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Flutter Developer</h4>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div>
                                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="font-bold text-black dark:text-white sm:text-lg">
                                        Helsinki, Finland - <span class="text-primary">Remote</span>
                                    </div>
                                </div>
                                <a
                                    href="javascript:"
                    ...
                    <div class="project" :class="activeTab === 'all' || activeTab === 'marketing' ? 'block' : 'hidden'">
                        <div
                            class="group rounded-[32px] border-2 border-white bg-white px-4 py-6 transition hover:border-secondary hover:bg-secondary/10 dark:border-gray-dark dark:bg-gray-dark dark:hover:border-secondary dark:hover:bg-secondary sm:p-[30px]"
                        >
                            <h6 class="mb-5 text-base font-black uppercase text-secondary dark:group-hover:text-black">Digital marketing</h6>
                            <h4 class="mb-10 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Sr. SEO Expert</h4>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div>
                                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="font-bold text-black dark:text-white sm:text-lg">
                                        Owings, Maryland - <span class="text-primary">Remote</span>
                                    </div>
                                </div>
                                <a
                                    href="javascript:"
