    ...
    <div>
                        ...
                        <div class="relative mt-6 md:mt-0" :data-aos="store.direction === 'rtl' ? 'fade-right' : 'fade-left'" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M179.857 113.28L210.685 107.652" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M228.828 60.36L229.248 65.288" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M225.02 70.328L220.092 70.776" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M239.217 69.068L234.289 69.516" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M230.481 79.484L230.061 74.556" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M140.124 201.369L124.418 195.92" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M156.086 133.72L157.57 135.848" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M175.352 1.21601L195.236 110.33" stroke="white" stroke-width="0.75" stroke-linecap="round" />
                                <path
                                    d="M197.888 139.516L203.068 138.564L201.556 130.276C200.044 130.612 198.252 130.865 196.398 131.256L197.888 139.516Z"
                                    stroke="white"
                                    stroke-width="0.75"
        ...
        <div class="py-14 md:py-[100px]">
            <div class="container">
                ...
                <div class="pb-12">
                    <h4 class="pb-5 text-xl font-bold text-black dark:text-white sm:text-2xl">How we use your information</h4>
                    <p class="pb-5 text-lg font-medium">We use the information we collect in various ways, including to:</p>
