    ...
    <div>
                    ...
                    <div class="relative flex flex-col items-center bg-[url('/assets/images/world-map.png')] bg-cover bg-top bg-no-repeat lg:flex-row lg:py-9">
                        <div class="flex-1 py-10 text-center text-white ltr:lg:text-left rtl:lg:text-right">
                            <h2 class="text-4xl font-extrabold leading-normal sm:text-5xl lg:text-[55px] lg:leading-[70px]">
                                Building the <span class="italic text-primary">future</span> of <span class="italic text-secondary">Crypto Revolution</span>
                            </h2>
                            ...
                            <button type="button" class="btn mx-auto mt-2 block bg-white py-[18px] px-8 rtl:ml-auto lg:mx-0">REGISTER NOW</button>
                        </div>
                        <div>
                            <img
            ...
            <div class="container">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                        <div class="flex justify-between">
                            <div class="flex items-center gap-2.5">
                                <NuxtLink to="javascript:" class="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#F7931A]">
                                ...
                                <h4 class="text-lg font-bold text-black dark:text-white">BTC</h4>
                                <span class="rounded bg-[rgba(198,198,198,0.4)] py-1 px-[6px] text-[10px] font-semibold leading-3 text-black dark:text-white"
                                    >BITCON</span
                                >
                            </div>
                            <div>
                        ...
                        <div class="flex items-center justify-between gap-2">
                            <div>
                                <h3 class="text-xl font-bold leading-[25px] text-black dark:text-white">$56,623.54</h3>
                                <h4 class="mt-2 text-lg font-semibold text-[#12AF97]">1.41%</h4>
                            </div>
                            <div>
                                <client-only> <apexchart height="55" :options="successChartOptions" :series="successChartSeries"></apexchart> </client-only>
                            </div>
                        </div>
                    </div>
                    <div class="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                        <div class="flex justify-between">
                            <div class="flex items-center gap-2.5">
                                <NuxtLink to="javascript:" class="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#345d9d]">
                                ...
                                <h4 class="text-lg font-bold text-black dark:text-white">ETH</h4>
                                <span class="rounded bg-[rgba(198,198,198,0.4)] py-1 px-[6px] text-[10px] font-semibold leading-3 text-black dark:text-white"
                                    >ETHEREUM</span
                                >
                            </div>
                        ...
                        <div class="flex items-center justify-between gap-2">
                            <div>
                                ...
                                <h4 class="mt-2 text-lg font-semibold text-[#FF0000]">-2.22%</h4>
                            </div>
                            <div>
                                <client-only> <apexchart height="55" :options="dangerChartOptions" :series="dangerChartSeries"></apexchart> </client-only>
                            </div>
                        </div>
                    </div>
                    <div class="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                        <div class="flex justify-between">
                            <div class="flex items-center gap-2.5">
                                <NuxtLink to="javascript:" class="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#F3BA2F]">
                                ...
                                <h4 class="text-lg font-bold text-black dark:text-white">BNB</h4>
                                <span class="rounded bg-[rgba(198,198,198,0.4)] py-1 px-[6px] text-[10px] font-semibold leading-3 text-black dark:text-white"
                                    >BINANCE</span
                                >
                            </div>
                    ...
                    <div class="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                        <div class="flex justify-between">
                            <div class="flex items-center gap-2.5">
                                <NuxtLink to="javascript:" class="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#53ae94]">
                                ...
                                <h4 class="text-lg font-bold text-black dark:text-white">USDT</h4>
                                <span class="rounded bg-[rgba(198,198,198,0.4)] py-1 px-[6px] text-[10px] font-semibold leading-3 text-black dark:text-white"
                                    >TETHER</span
                                >
                            </div>
                        ...
                        <div class="item-center flex justify-between gap-2">
                            <div>
                                <h3 class="text-xl font-bold leading-[25px] text-black dark:text-white">$0.9998</h3>
                                <h4 class="mt-2 text-lg font-semibold text-[#FF0000]">-0.03%</h4>
                            </div>
                            <div>
                                <client-only> <apexchart height="55" :options="dangerChartOptions" :series="dangerChartSeries"></apexchart> </client-only>
                            </div>
            ...
            <div class="container">
                <div class="flex flex-col items-center justify-between gap-10 md:flex-row md:gap-0">
                    <div class="text-center ltr:md:text-left rtl:md:text-right">
                        <h6 class="mb-3 text-lg font-extrabold text-primary sm:mb-4">ABOUT US</h6>
                        ...
                        <button type="button" class="btn mt-7 text-white">Get Started</button>
                    </div>
                    <div>
                        ...
                        >
                            <div class="text-center">
                                <count-up
                                    ...
                                    :options="{ suffix: 'M+' }"
                                ></count-up>
                                <span class="font-bold text-black transition dark:text-white dark:group-hover:text-black">Active Users</span>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        >
                            <div class="text-center">
                                ...
                                ></count-up>
                                <span class="font-bold text-black transition dark:text-white dark:group-hover:text-black">Already Earned</span>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        >
                            <div class="text-center">
                                <count-up
                                    ...
                                    :delay="10"
                                ></count-up>
                                <span class="font-bold text-black transition dark:text-white dark:group-hover:text-black">Avg Brating</span>
                            </div>
                        </div>
                    </div>
                    <div>
                ...
                <div class="container">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        >
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-white">Execution from experts</h4>
                                <p class="mt-2.5 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-white">Provides a different perspective</h4>
                                <p class="mt-2.5 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-white">Trailing Stop</h4>
                                <p class="mt-2.5 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-white">Latest Information</h4>
                                <p class="mt-2.5 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            </div>
                        </div>
                        <div
                            class="flex gap-[15px] border-b border-dashed px-4 py-5 sm:border-b-0 sm:py-9 ltr:sm:border-r rtl:sm:border-l"
                            data-aos="fade-up"
                            data-aos-duration="1000"
                        >
                            <div>
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-white">We Provide Quality Content</h4>
                                <p class="mt-2.5 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            </div>
                        </div>
                        <div class="flex gap-[15px] px-4 py-5 sm:py-9" data-aos="fade-up" data-aos-duration="1000">
                            <div>
                                <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-white">Platform Fees</h4>
                                <p class="mt-2.5 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-12 lg:py-24">
            <div class="container">
                <div class="heading text-center">
                    <h6>Crypto & NFT</h6>
                    <h4 class="text-4xl md:!text-[46px] md:!leading-[57px]">All your crypto and NFTs in one place</h4>
                </div>
        ...
        <section class="bg-[#47BDFF] bg-[url(/assets/images/crypto/our-partners.png)] bg-cover bg-center bg-no-repeat py-12 dark:bg-black md:py-24">
            <div class="container">
                <h2 class="text-center text-3xl font-black text-white sm:text-4xl md:text-[46px] md:leading-[58px]">We featured on popular partners like</h2>
                <div class="mt-12 grid grid-cols-2 gap-4 md:gap-7 lg:grid-cols-4">
                    <div
                        class="group flex items-center justify-center rounded-[20px] bg-white py-10 px-[50px] text-[#8C98A4] duration-200 hover:bg-black hover:text-white dark:bg-gray-dark"
                    >
                    ...
                    >
                        <svg width="150" height="50" viewBox="0 0 150 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_15_88925)">
                                <path
        ...
        <section class="overflow-hidden py-12 lg:py-24">
            <div class="container">
                <div class="flex flex-col gap-5 lg:flex-row lg:gap-24">
                    ...
                    <div class="heading flex-1">
                        ...
                        <button type="button" class="btn mt-6 py-[18px] px-8 text-base text-white">Find Out More</button>
                    </div>
                </div>
            </div>
        </section>
