<template>
    <div>
            ...
            <div class="container lg:pt-7">
                <div class="relative">
                    <div class="pt-14 pb-8 text-center text-white lg:w-3/5 lg:py-20 ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <NuxtLink to="javascript:" class="btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">Free trial</NuxtLink>
                    </div>
                    <div
            ...
            <div class="container">
                <div class="relative">
                    ...
                    <img
                        ...
                        alt=""
                        class="top-0 mx-auto mt-10 ltr:-right-[125px] rtl:-left-[125px] lg:absolute lg:mt-0"
                    />
                </div>
            </div>
        </section>
        ...
        <section class="relative overflow-hidden bg-black py-14 lg:py-24">
