                        ...
                        <div class="relative mt-6 md:mt-0" :data-aos="store.direction === 'rtl' ? 'fade-right' : 'fade-left'" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M288.699 136.955L293.653 129.924" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M248.576 194.385L264.28 171.916" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M180.889 192.212L196.101 189.513" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M187.162 183.238L189.826 198.486" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M275.777 221.13L297.054 217.38" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M284.541 208.616L288.292 229.928" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M135.215 116.498L137.244 116.738" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M301.277 159.925L328.198 154.211" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
            ...
            <div class="container">
                <div class="pb-12">
                    ...
                    <p class="pb-5 text-lg font-medium">
                        ...
                        provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic
                    ...
                    <p class="pb-5 text-lg font-medium">
                        ...
                        Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of careers.padme.com,
                        life. padme.com & blog.padme.com website.
                    </p>
                    <p class="pb-5 text-lg font-medium">
                    ...
                    <p class="pb-5 text-lg font-medium">
                        By accessing this website we assume you accept these terms and conditions. Do not continue to use Website Name if you do not agree to
                ...
                <div class="pb-12">
                    ...
                    <p class="pb-5 text-lg font-medium">
                        Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all material on Website Name. All
                        intellectual property rights are reserved. You may access this from Website Name for your own personal use subjected to restrictions set
                    ...
                    <p class="pb-5 text-lg font-medium">
                        ...
                        Company Name does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views
                        and opinions of Company Name,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                        and opinions.
                    </p>
                    <p class="pb-5 text-lg font-medium">
                        Company Name reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or
                ...
                <div>
                    ...
                    <ul class="pb-5 text-lg font-medium">
                        ...
                        >
                            ...
                            businesses; and System wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and charity
                            fundraising groups
                        </li>
                    </ul>
