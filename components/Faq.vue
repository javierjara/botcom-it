<template>
    <div class="container">
        <div class="heading text-center">
            <template v-if="type.toLowerCase() === 'construction'">
                <h4 class="!font-black !text-primary">FAQ’S</h4>
                <p class="mx-auto mt-5 max-w-[663px] text-lg font-medium dark:text-white">
