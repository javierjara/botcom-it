<template>
    <footer class="mt-auto bg-black dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.03] dark:to-transparent">
        <div class="container">
            <div class="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-4 lg:py-[100px]">
                <div class="relative">
<div class="w-full flex flex-col items-center text-white text-center">
    <svg class="w-[100px]" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" version="1.0" viewBox="65.62 29.69 242.25 227.3">
                            <defs>
                            ...
                            <g clip-path="url(#c159062813)">
                                <path d="M186.727 57.117c.773 0 1.484.434 1.84 1.121l40.09 77.383h13.382l-55.312-105.91-55.313 105.91h13.383l40.086-77.383a2.075 2.075 0 0 1 1.844-1.12Zm0 0"/>
                            </g>
                            <g clip-path="url(#93d74389d1)">
                                <path d="m240.516 155.875 45.91 86.29a2.074 2.074 0 0 1-1.832 3.042H88.855a2.073 2.073 0 0 1-1.832-3.043l45.91-86.289h-13.367L65.77 256.985h241.91l-53.797-101.11Zm0 0"/>
                            </g>
                            <path d="M73.371 139.762h226.707v11.972H73.371Zm0 0"/>
                            </svg>
</div>
    ...
    <ul class="mt-12 flex items-center gap-8 ">
                            ...
                            <a href="javascript:">
                                ...
                                >
                                    ...
                                    <path
                                        ...
                                        fill="#ffffff"
                                    />
                                    <circle cx="17.7975" cy="5.08737" r="0.732875" fill="#ffffff" />
                                </svg>
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    <ul class="flex flex-col gap-2 ">
                        <li class="mb-3 text-lg  text-white dark:text-white underline">Botcom</li>
                        <li class="text-white"> P.IVA IT02751520186</li>
                        <li class="text-white">Via Meucci 47/A, Milano(MI) 20127</li>
                       
                        
                        <li>
                            <a href="mailto:hello@botcom.it" class="inline-block transition hover:scale-110 text-white hover:text-secondary">hello@botcom.it</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <ul class="flex flex-col gap-2 ">
                        <li class="mb-3 text-lg  text-white dark:text-white underline">Link utili</li>
                        <li>
                            <NuxtLink to="/" class="inline-block transition hover:scale-110 text-white hover:text-secondary">Home</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/career" class="inline-block transition hover:scale-110 text-white hover:text-secondary">Collabora con noi</NuxtLink>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    <ul class="flex flex-col gap-3 ">
                        <li class="mb-3 text-lg  text-white dark:text-white underline">Dicono di noi</li>
                        <li class="text-white">
                            Truspilot
                        </li>
        ...
        <div class="bg-black py-5 dark:border-t-2 dark:border-white/5 dark:bg-none">
            <div class="container">
                <div class="flex flex-col items-center text-white text-center  dark:text-white">
                    <div>
